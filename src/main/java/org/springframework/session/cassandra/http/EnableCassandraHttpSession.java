 ...
 * </pre>
 *
 * More advanced configurations can extend {@link CassandraHttpSessionConfiguration} instead.
 *
...
public @interface EnableCassandraHttpSession {
	 ...
	 */
	String tableName() default CassandraSessionRepository.DEFAULT_TABLE_NAME;
